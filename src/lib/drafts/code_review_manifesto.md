...
- Code changes are needed for a code review, however, care needs to be put into these changes s.t.
  they are reviewable.
  Changes should be - Neat: you are an author of code, so consider your audience. - Small: [Big vs. small PR : r/programminghumor](https://www.reddit.com/r/programminghumor/comments/14uzv4w/big_vs_small_pr/) - Focused on the requirements: plz don't run a new formatter on 200 files in your simple feature PR.
